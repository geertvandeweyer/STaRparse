by_locus = function(df, output, savename, build, humandb, globdir){
  #     Housekeeping
  ...
  # mk command explicit.
  perl_script = file.path(globdir,"Source", "summaries", "annotate_variation.pl")
...
by_chr = function(df, locus, output){
  # TODO : use a genome dict for this
