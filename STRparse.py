...
''')
    ...
    def summaries(self):
        ...
        main(args.csvinput, args.summaryoutput, args.savename, args.gbuild, args.humandb,  globdir, args.reference)
    ...
    def individual(self):
        ...
        main(args.csvinput, args.output, args.savename,   globdir, args.reference)
